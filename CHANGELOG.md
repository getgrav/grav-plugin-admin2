...
1. [](#bugfix)
    ...
    * Date and time fields now put their day, month and year boxes in the order your own region writes them, rather than always the American month-day-year. Typing a day above the twelfth into the first box no longer lands it in the month [#166](https://github.com/getgrav/grav-plugin-admin2/issues/166)
